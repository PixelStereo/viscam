...
class Pan_Tilt_UI(QGroupBox):
    ...
    def __init__(self, visca, v):
        ...
        pan_tilt_layout.addWidget(visca.tilt_speed, 1, 2, 1, 1)
        pan_tilt_layout.addWidget(visca.home, 1, 5, 1, 1)
        pan_tilt_layout.addWidget(visca.reset, 2, 5, 1, 1)
        pan_tilt_layout.addWidget(visca.pan, 3, 5, 1, 1)
        pan_tilt_layout.addWidget(visca.pan_speed, 1, 1, 1, 1)
        pan_tilt_layout.addWidget(visca.tilt, 4, 5, 1, 1)
        pan_tilt_layout.addWidget(visca.upleft, 2, 1, 1, 1)
        pan_tilt_layout.addWidget(visca.up, 2, 2, 1, 1)
        pan_tilt_layout.addWidget(visca.upright, 2, 3, 1, 1)
        pan_tilt_layout.addWidget(visca.left, 3, 1, 1, 1)
        pan_tilt_layout.addWidget(visca.stop, 3, 2, 1, 1)
        pan_tilt_layout.addWidget(visca.right, 3, 3, 1, 1)
        pan_tilt_layout.addWidget(visca.downleft, 4, 1, 1, 1)
        pan_tilt_layout.addWidget(visca.down, 4, 2, 1, 1)
        pan_tilt_layout.addWidget(visca.downright, 4, 3, 1, 1)
